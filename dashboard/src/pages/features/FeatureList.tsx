...
const FeatureList: React.FC = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ['features', page, rowsPerPage, debouncedSearch],
    queryFn: () => {
  ...
  return (
    <Box>
            ...
            <TableBody>
              {features.length === 0 ? (
                ...
                features.map((feature: any) => (
                  <TableRow key={feature._id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    ...
                    <TableCell align="right">
                      <IconButton color="primary" onClick={() => navigate(`/features/${feature._id}/edit`)}>
                        <EditIcon />
                      </IconButton>
                      <IconButton color="error" onClick={() => setDeleteId(feature._id)}>
                        <DeleteIcon />
                      </IconButton>
                    </TableCell>
                  </TableRow>
      ...
      <Dialog open={!!deleteId} onClose={() => setDeleteId(null)}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete this feature? This action cannot be undone and may affect vehicles that are currently using it.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
